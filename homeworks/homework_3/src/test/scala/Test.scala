...
object Test extends TestSuite {
    ...
    'test_referenceCell - {
        val table = new Table(2, 3)
        /*ix = 0*/
        table.setCell(0, 0, new ReferenceCell(0, 1, table))
        table.setCell(0, 1, new ReferenceCell(0, 2, table))
        table.setCell(0, 2, new ReferenceCell(1, 0, table))
        table.setCell(1, 0, new ReferenceCell(1, 1, table))
        table.setCell(1, 1, new ReferenceCell(1, 2, table))
        table.setCell(1, 2, new ReferenceCell(0, 2, table))
        assert(table.getCell(0, 2).toString.contains("cyclic"))
    }
    }
}
